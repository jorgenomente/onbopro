...
import { OrgCoursePreviewScreen } from '@/app/org/courses/[courseId]/preview/page';

export default function SuperadminOrgCoursePreviewPage() {
  ...
  return (
    <SuperadminGuard>
      <OrgCoursePreviewScreen courseId={courseId} basePath={basePath} />
    </SuperadminGuard>
  );
}
