...
units_lessons as (
  ...
  join public.course_units cu on cu.course_id = a.course_id
...
user_completions as (
  ...
  from public.lesson_completions lcpl
...
left join public.quizzes qu_unit
  on qu_unit.type = 'unit'
 and qu_unit.unit_id = ul.unit_id
left join public.quizzes qu_final
